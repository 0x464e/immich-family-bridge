...
**Project status:** This is an early release. It was exercised end to end with three accounts, ordinary JPEGs, XMP sidecars, and a 1,200-image delayed-import batch on a disposable Immich 3.2.2 instance backed by an NFS-mounted ZFS dataset. It has not been validated against a 14,000-asset batch, and video and other coupled media have not had live end-to-end testing. See the [validation record](docs/live-validation.md) and [current limits](#current-limits-and-production-pilot) before connecting important media.
